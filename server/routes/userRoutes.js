...
router.post('/register', async (req, res) => {
  ...
  try {
    ...
    if (existingUser)
      return res.status(400).json({ message: 'User already exists o to the login page' });
    ...
    res.status(201).json({ message: 'User registered successfully go to the login page' });
  } catch (error) {
